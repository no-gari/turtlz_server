...
class MagazinesAdminForm(forms.ModelForm):
    class Meta:
        ...
        fields = ( 'scrapped_users', 'is_main', 'is_banner', 'banner_image', 'like_users', 'published',
                  'title', 'subtitle', 'hits', 'comments_banned', 'content', 'collection', 'brand', 'order', 'magazine_url')
